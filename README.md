## Статьи
- [Распутывая циклы Ansible](./articles/looping_loops.md)
- [Пишем роли ansible не ломая прод — особенности check_mode или как правильно его готовить](./articles/ansible_check.md)
...
- [Kubernetes: сетевые политики](./sobes_sre_devops/kubernetes_network_policies.md)
- [Kubernetes: масштабирование](./sobes_sre_devops/kubernetes_scaling.md)
- [Kubernetes: Helm](./sobes_sre_devops/kubernetes_helm.md)

### Базы данных
- [PostgreSQL](./sobes_sre_devops/postgresql.md)
- [etcd](./sobes_sre_devops/etcd.md)

### Linux
- [Общие вопросы по Linux](./sobes_sre_devops/linux.md)
- [Диагностика Linux (Часть 1)](./sobes_sre_devops/linux_troubleshooting1.md)
- [Диагностика Linux (Часть 2)](./sobes_sre_devops/linux_troubleshooting2.md)
...
- [Observability и Incident Response](./sobes_sre_devops/observability_incident_response.md)
- [System Design для SRE/DevOps](./sobes_sre_devops/system_design_sre_devops.md)
- [Cloud Patterns для интервью](./sobes_sre_devops/cloud_patterns_for_interviews.md)

### Security / DevSecOps
- [Vault](./sobes_sre_devops/vault.md)
- [DevSecOps Common](./sobes_sre_devops/devsecops_common.md)
- [DevSecOps Security & Compliance](./sobes_sre_devops/devsecops_security_compliance.md)
