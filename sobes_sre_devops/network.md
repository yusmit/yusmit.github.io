...
## **Вывод**
- **Коммутация (L2)** — быстрая доставка кадров внутри одной сети по MAC-адресам.
- **Маршрутизация (L3)** — передача пакетов между разными сетями по IP-адресам.
- **ARP** связывает L2 и L3.
- Для диагностики используйте:
  - L2: `mac address-table`, `arp -a`, `tcpdump`.
  - L3: `ip route`, `traceroute`, `ping`.
